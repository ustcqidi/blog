...
_YYModelMeta是核心的数据结构，它主要记录了Model对象的相关信息，比如类信息(类名、方法列表、属性列表)、属性列表、key和key path的映射表等等。
...
YYClassInfo用来表示model class的基本信息：model类对象、父类对象、类名、属性列表、方法列表等等，作者使用oc runtime方法来初始化YYClassInfo类。
