...
## 主要项目经验
### 动态化跨平台框架 
负责方案的调研、设计与实现。基于 React Native 实现了爱奇艺的移动端跨平台开发框架，完成了基础库开发、工具链开发、性能优化，并在爱奇艺公司内部各个业务线推广与落地。目前已经在 Android 和 iOS 双端稳定运行，有10个以上业务方接入改框架，线上页面数量100个以上，节省了开发人力，提高开发效率
